...
/** updateVoucher POST /api/user/update/avatar */
export async function updateVoucherUsingPOST(
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseImageVo>('/api/user/update/avatar', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
export async function updateVoucherUsingPOST1(options?: { [key: string]: any }) {
